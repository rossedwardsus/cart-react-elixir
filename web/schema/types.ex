defmodule Sconely.Schema.Types do
  ...
  object :process_collection_order do
    field :status, :string
    field :sconely_user_token, :string
    #field :stripe__token, :string
    field :error_code, :string
  ...
  object :pool_order_details do
    ...
    field :pool_delivery_time_range, :string
    field :pool_address_street1, :string
    field :pool_address_street2, :string
    field :pool_address_city, :string
    field :pool_address_state, :string
    field :pool_address_zipcode, :string
