defmodule Sconely.MenuItemsController do
  ...
  def index(conn, _args) do
    ...
    json conn |> put_status(:ok), %{items: Repo.all(from mi in MenuItem, select: %{id: mi.id, menu_item_id: mi.menu_item_id, name: mi.name, description: mi.description, ingredients: mi.ingredients}, order_by: mi.id)}
