defmodule Sconely.CollectionsController do
  ...
  def get_collection_items(conn, _args) do
    #IO.puts("create graphql")
    ...
    #{:ok, Repo.all(from c in CollectionItems, select: %{id: mi.id, name: mi.name, description: mi.description, ingredients: mi.ingredients}, order_by: mi.id)}
    #{:ok, [%{item_id: 1000}]}
