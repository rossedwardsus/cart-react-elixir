                    ...
                    <div className="row">
                          <div className="hidden-xs col-md-3" style={{paddingLeft: 55}}>
                            ...
                            {(this.props.User.orders[0].order_type == "social" && this.props.User.orders[0].cartItems.length == 0) &&
                              (<div><br/>Order by the dozen or 2 dozen for minis<br/>Plan ahead, order at least 48 hours in advance<br/><br/><b>Free Delivery</b><br/>Downtown LA<br/>Santa Monica<br/>Venice<br/><br/>Wednesday-Saturday<br/>9am-Noon<br/><br/>Contact us for other delivery options</div>)}
