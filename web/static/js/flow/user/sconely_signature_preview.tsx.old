...
import {getEventName} from '../selectors/signature_order.ts';
...
class SignatureOrderPreview extends React.Component<any, any> {
  ...
  constructor(props: any) {
    ...
    //this.getData();
       ...
       this.state = {
        ...
        event_name: "We are having complimentary scones for Event Name. Please select the scone you'd like before THREE DAYS BEFORE DELIVERY DATE.  Thanks, FIRST + LAST NAME OF HOST"
  ...
  componentWillMount = () => {
      ...
      if(this.props.event_name != ""){

          this.setState({event_name: "We are having complimentary scones for " + this.props.event_name + ". Please select the scone you'd like before THREE DAYS BEFORE DELIVERY DATE.Thanks, FIRST+ LAST NAME OF HOST"});
      ...
      <div>
        ...
        <div className="row">
                    <div className="hidden-xs col-md-3" style={{wordWrap: "break-word", overflowWrap: "break-word", textOverflow: "ellipsis"}}>
                      ...
                      <br/>
                      <div className="form-group">
                        <textarea className="form-control" rows={8} id="comment" style={{resize: "none"}} value={this.state.event_name}></textarea>
                      </div>
...
function mapStateToProps(state: any, ownProps: any) {
  ...
  return {
   event_name: getEventName(state, ownProps.params.order_id),
