...
class YoursOrderMenu extends React.Component<any, any> {
  //props: Props;
    ...
    if(cartItemsQuantity < 11){
        ...
        quantity_selector =  <div>
                                <div className="col-xs-12 col-md-9">
                                  ...
                                  <div className="col-xs-6 col-md-4">
                                    <button className={this.state.add_cart_item_button_classname} disabled={this.state.add_cart_item_button_disabled} type="button" onClick={() => this.addCartItem()} style={{borderRadius: 0, WebkitAppearance: "none", height: 35, width: 100}}>Add To Cart</button>
                                  </div>
                                </div>
                              </div>
      }else{
        ...
        //}
          ...
          return(<div>
                    <PublicTopNavbar/>
                    <div className="row">
                          <div className="hidden-xs col-sm-3 col-md-3" style={{paddingLeft: 45}}>
                            <br/>
                            <br/>
                            <b>SCONELY {this.props.User.orders[0].order_type.toUpperCase()}</b>
                            <br/>
                            {(this.props.User.orders[0].cartItems.length == 0) &&
                                  <div>
                                    <br/>
...
const YoursOrderMenuConnected = connect(
  mapStateToProps,
  mapDispatchToProps
)(YoursOrderMenu);

export default YoursOrderMenuConnected;
