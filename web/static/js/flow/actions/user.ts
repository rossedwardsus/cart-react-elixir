...
export function setUserPaymentMethodNameOnCard(id: any, name: any) {
  //console.log("state" + JSON.stringify(state));
  console.log("set user payment name action");
  return function (dispatch: any) {

      dispatch({type: SET_USER_PAYMENT_METHOD_NAME_ON_CARD, id: id, value: name});
...
export function setUserPaymentMethodZipCode(id: any, number: any) {
  //console.log("state" + JSON.stringify(state));
  console.log("set user payment year action");
  return function (dispatch: any) {

      dispatch({type: SET_USER_PAYMENT_METHOD_ZIPCODE, id: id, value: number});
