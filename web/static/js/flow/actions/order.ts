    ...
    return function(dispatch: any){
      ...
      //      dispatch(push("/order/menu"));
            ...
            .then((response: any) => {
                  ...
                  let pool_order_by_date_formatted = moment(order_by_date).format('ddd') + ", " + moment(order_by_date).format('MMMM') + " " + moment(order_by_date).format('D') + ", 5:30 pm";
