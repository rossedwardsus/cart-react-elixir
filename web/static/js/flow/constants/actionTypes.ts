...
export const GET_USER_PAYMENT_NAMES = 'GET_USER_PAYMENT_NAMES'
...
export const GET_USER_DELIVERY_ADDRESS_NAMES = 'GET_USER_DELIVERY_ADDRESS_NAMES'
export const GET_USER_DELIVERY_ADDRESSES = 'GET_USER_DELIVERY_ADDRESSES'
export const ADD_USER_DELIVERY_ADDRESS = 'SET_USER_DELIVERY_ADDRESS'
...
export const GUEST_ADD_CART_ITEM = 'GUEST_ADD_CART_ITEM'
export const SET_GUEST_FIRST_NAME = 'SET_GUEST_FIRTS_NAME'
export const SET_GUEST_LAST_NAME = 'SET_GUEST_LAST_NAME'
export const SET_GUEST_EMAIL = 'SET_GUEST_EMAIL'
export const SET_GUEST_HOST_MESSAGE = 'SET_GUEST_HOST_MESSAGE'
