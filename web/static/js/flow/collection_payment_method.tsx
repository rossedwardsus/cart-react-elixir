...
class CollectionPaymentMethod extends React.Component<any, any> {
  //props: Props;
  ...
  constructor(props: any) {
    ...
    this.state = {
       ...
       security_code_disabled: false,
       card_number_border_color: "grey",
       card_number_disabled: false,
       expiry_month_border_color: "grey",
       expiry_date_month_disabled: false,
       expiry_year_border_color: "grey",
       expiry_date_year_disabled: false,
