              ...
              <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-7" style={{paddingLeft: "30px"}}>
                            ...
                            <br/>
                            <br/>
                            Ordering is easy with the following services. Just click on the link on our homepage to view the menu, select your scones, then check out. Sconely sends a confirmation email after an order is placed.
                            <br/>
                            <br/>
                            Sconely Social: 1 dozen ($60) - 20 dozen regular sized scones and / or 2 dozen ($54) – 40 dozen mini scones, delivered to your event.
                            <br/>
                            <br/>
                            Sconely Pool: 1-11 scones ($5 each), for a group of 5 or more people, delivered to one location. One person initiates order and sends link to others in their group to order and pay individually. Email us to start an order. 
                            <br/>
                            <br/>
                            ...
                            <br/>
                            <br/>
                            Currently we deliver to Beverly Hills, Brentwood, Century City, Downtown LA, Marina Del Rey, Playa Vista, Hancock Park, Santa Monica, West Hollywood, Westwood and Venice between 8am and noon, Wednesday through Saturday. Contact us at orders@sconely.com to inquire about delivery outside these areas and times. Free pick up at our DTLA location is also possible.<br/>
                            <br/>
