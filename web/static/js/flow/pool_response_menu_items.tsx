...
import PoolResponseSidebarCart from './pool_response_sidebar_cart.tsx';
...
class PoolResponseMenuItems extends React.Component<any, any> {
  //props: Props;
...
export default PoolResponseMenuItems;
